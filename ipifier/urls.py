...
urlpatterns = patterns('',
    ...
    url(r'^edit/iprange/(?P<range_id>\d+)/$', 'iptracker.views.edit_iprange', name='edit-iprange'),
    ...
    url(r'^del/iprange/(?P<range_id>\d+)/$', 'iptracker.views.del_iprange', name='del-iprange'),
    ...
    url(r'^del/del/iprange/(?P<range_id>\d+)/$', 'iptracker.views.del_del_iprange', name='del-del-iprange'),
    ...
    url(r'^add/entry/warn$', 'iptracker.views.add_entry_warn', name='add-entry-warn'),
    ...
    url(r'^add/ip/(?P<ip>[\w\.]+)/$', 'iptracker.views.add_ip_ip', name='add-ip-ip'),
